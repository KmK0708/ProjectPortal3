...
void APortalCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	// Bind fire event
	//PlayerInputComponent->BindAction("Fire", IE_Pressed, this, &APortalCharacter::OnFire);

	// Enable touchscreen input
	EnableTouchscreenMovement(PlayerInputComponent);

	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &APortalCharacter::OnResetVR);
	...
	PlayerInputComponent->BindAxis("TurnRate", this, &APortalCharacter::TurnAtRate);
	PlayerInputComponent->BindAxis("LookUp", this, &APawn::AddControllerPitchInput);
	PlayerInputComponent->BindAxis("LookUpRate", this, &APortalCharacter::LookUpAtRate);


	PlayerInputComponent->BindAction("FireBlue", IE_Pressed, this, &APortalCharacter::OnBlueFire);
	PlayerInputComponent->BindAction("FireRed", IE_Pressed, this, &APortalCharacter::OnRedFire);


}

void APortalCharacter::OnFire()
{
	...
	if (ProjectileClass != nullptr)
	{
		...
		if (World != nullptr)
		{
			if (bUsingMotionControllers)
			{
				...
				World->SpawnActor<APortalProjectile>(ProjectileClass, SpawnLocation, SpawnRotation);
			}
			else
			{
...
void APortalCharacter::EndTouch(const ETouchIndex::Type FingerIndex, const FVector Location)
{
...
bool APortalCharacter::EnableTouchscreenMovement(class UInputComponent* PlayerInputComponent)
{
	if (FPlatformMisc::SupportsTouchInput() || GetDefault<UInputSettings>()->bUseMouseForTouch)
	{
		PlayerInputComponent->BindTouch(EInputEvent::IE_Pressed, this, &APortalCharacter::BeginTouch);
		PlayerInputComponent->BindTouch(EInputEvent::IE_Released, this, &APortalCharacter::EndTouch);

		//Commenting this out to be more consistent with FPS BP template.
		//PlayerInputComponent->BindTouch(EInputEvent::IE_Repeat, this, &APortalCharacter::TouchUpdate);
		return true;
	}
